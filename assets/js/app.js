...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
    <h2 class="title card-title">Now</h2>
                        <div class="weapper">
                            <p class="heading">${parseInt(
                              temp
                            )}&deg;<sup class="sup_celsius">c</sup></p>

                            <img src="./assets/images/weather_icons/${icon}.png" height="64" width="64"
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card">
                                    ...
                                    <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48"
                                        loading="lazy" class="weather-icon" alt="${description}" title="${description}">
        ...
        <div class="card card-sm slider-card">
                                    ...
                                    <img src="./assets/images/weather_icons/direction.png" width="48" height="48"
                                        loading="lazy" class="weather-icon" alt="direction" style="transform: rotate(${
                                          windDirection - 180
                                        }deg)">
